      ...
      <div className={styles.aboutContent}>
        <div className={styles.aboutText}>
          ...
          <div style={{ marginTop: '2rem' }}>
            <a href={process.env.NODE_ENV === 'production' ? "/portfolio/resume.pdf" : "/resume.pdf"} target="_blank" rel="noopener noreferrer" className={styles.primaryBtn} style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
